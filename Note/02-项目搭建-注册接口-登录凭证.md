...
在 Node 项目中，使用 .env 文件，加载全局变量，要用到一个库 _dotenv_；安装 _dotenv_
...
事实上，每个 http 请求，对于服务器来说，都是单独的请求，和之前请求过什么，没有关系。
...
默认情况下的 cookie，是内存 cookie，也称之为**会话 cookie**，也就是在浏览器关闭时会自动被删除；
