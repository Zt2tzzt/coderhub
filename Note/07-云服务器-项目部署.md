...
* Windows 电脑上，推荐直接使用 git bash 终端的 ssh 工具；
* Mac OS 电脑上可直接通过终端来使用 ssh 工具；
...
**第二步：在 Navicat 工具中本地 MySQL 直接导出数据库*，生产 .sql 文件**

![Navicat导出](https://tva1.sinaimg.cn/large/0081Kckwgy1glbwjehnpyj30ci08w43h.jpg)



**第三步：在 Navicat 工具中，服务器 MySQL 中执行导出的 .sql 文件**
