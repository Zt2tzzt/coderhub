...
在 coderhub 数据库中，moment 表中，插入测试数据。
...
class CommentController {
  ...
  async create(ctx, next) {
    ...
    console.log('momentId:', momentId, typeof momentId)
    const { id } = ctx.user
